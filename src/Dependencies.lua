...
-- a basic StateMachine class which will allow us to transition  to and from game states smoothly and avoid monolithic code in one file
require 'src/StateMachine'

-- utility functions, mainly for splitting our sprite sheet into various Quads of different sizes for paddles, balls, bricks, etc.
require 'src/Util'
