...
function PaddleSelectState:render()
    ...
    -- left arrow; should render normally if we're higher than 1, else in a shadowy form to let us know we're as far left as we can go
    if self.currentPaddle == 1 then
    ...
    -- right arraw; should render normally if we're less than 4, else in a shadowy form to let us know we're as far right as we can go
    if self.currentPaddle == 4 then
        -- tint; give it a dark gray with half opacity
        love.graphics.setColor(40/255, 40/255, 40/255, 128/255)
    end
