...
--[[
    Creates a table of Bricks to be returned to the main game, with different possible ways of randomizing rows and columns of bricks. Calculates the brick colors and tiers to choose based on the level passsed in.
]]
function LevelMaker.createMap(level)
    ...
    for y = 1, numRows do
        ...
        -- whether we want to enable alternate colors for this row
        ...
        for x = 1, numCols do
            ...
            if skipPattern and skipFlag then
                ...
                -- flip the flag to turn on an iteration we don't use it
                skipFlag = not skipFlag
            end
            ...
            -- if not alternating we made it here, use the solid color/tier
